...
public class TimeUtil {
	 ...
	 * @return
	 */
	public static ArrayList<String> getMonthList(String beginDateStr, String endDateStr) {
		// 指定要解析的时间格式
	 ...
	 * @return
	 */
	public static String getDayByWeek(int year, int month, int week, boolean flag) {
	...
	public static String formatTimeString(String strTime) throws ParseException {
		SimpleDateFormat getsdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.sss");
